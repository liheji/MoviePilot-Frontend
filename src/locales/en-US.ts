export default {
  ...
  settingTabs: {
    system: {
      title: 'System',
      description: 'Access address, API token, appearance and runtime logs',
    },
    downloader: {
      title: 'Downloaders',
      description: 'Connections and download directories for qBittorrent, Transmission and more',
    },
    directory: {
    ...
    search: {
      ...
      description: 'Keyword site search, download task tags, and search site scope',
    },
    subscribe: {
      title: 'Subscription',
  ...
  liteDashboard: {
    title: 'Dashboard',
    description: 'Site search and download status',
    resourceStatus: 'Resource Status',
    sites: 'Sites',
    downloaders: 'Downloaders',
    loadingStatus: 'Loading status',
    readStatusFailed: 'Failed to load status',
    resourceStatusReadFailed: 'Failed to load {resource} status',
    notConfigured: 'No {resource} configured',
    available: '{count} {resource} available',
    configuredSummary: '{configured} configured · {enabled} enabled',
    notFetched: 'Not fetched',
    ...
    downloadSpeed: 'Download speed',
    uploadSpeed: 'Upload speed',
    accumulatedDownload: 'Total download',
    accumulatedUpload: 'Total upload',
    downloadDirectoryFreeSpace: 'Download directory free space',
    pathMappings: 'Path mappings',
    pathMappingCount: '{count}',
    noPathMappings: 'No path mappings configured',
    manageSites: 'Manage Sites',
    configureDownloaders: 'Configure Downloaders',
    addSite: 'Add Site',
  ...
  liteDownloadTask: {
    ...
    savePath: 'Save path',
    resume: 'Resume',
    missingResultHandle: 'Missing torrent result handle',
  },
  litePlugin: {
    loadErrorTitle: 'Component load error',
    loadErrorText: 'Unable to load the plugin full-page component.',
    dashboardLoadFailed: 'Failed to load plugin dashboard',
  },
  liteSearch: {
    keyword: 'Keyword',
    sites: 'Sites',
    search: 'Search',
    resultSites: 'Result Sites',
    promotion: 'Promotion',
    ...
    emptyTitle: 'Search Site Torrents',
    emptyText: 'Enter a keyword to view raw torrent results',
    settings: {
      basicDescription: 'Set the downloader tag used for manual download tasks.',
      siteScopeDescription: 'Set the default site scope for keyword searches.',
    },
  },
  dashboard: {
    storage: 'Storage',
  ...
  setting: {
    ...
    system: {
      ...
      basicSettingsDesc: 'Configure the access address, API token and appearance.',
      downloaderSettings: 'Downloader Settings',
      downloaderSettingsDesc: 'Configure downloader connections, defaults and download directories.',
      addDownloader: 'Add downloader',
      downloadDirectorySettings: 'Download Directories',
      downloadDirectorySettingsDesc: 'Configure local directories for manual downloads. The highest-priority directory is used when none is selected.',
      directoryName: 'Directory name',
      downloadPath: 'Download path',
      addDownloadDirectory: 'Add download directory',
      removeDownloadDirectory: 'Remove download directory',
      defaultDownloadDirectory: 'Download directory',
      noDownloadDirectories: 'No download directories configured',
      directorySaveSuccess: 'Download directories saved successfully',
      directorySaveFailed: 'Failed to save download directories!',
      ...
      ocrHost: 'OCR Server',
      ocrHostHint: 'Used to recognize graphic captcha images supplied by sites or plugins',
