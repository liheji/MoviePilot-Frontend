export default {
  ...
  settingTabs: {
    system: {
      title: '系统',
      description: '访问地址、接口令牌、外观与运行日志',
    },
    downloader: {
      title: '下载器',
      description: 'qBittorrent、Transmission 等下载器的连接和下载目录',
    },
    directory: {
      title: '存储 & 目录',
    ...
    search: {
      title: '搜索 & 下载',
      description: '关键词站点搜索、下载任务标签与搜索站点范围',
    },
    subscribe: {
      title: '订阅',
  ...
  liteDashboard: {
    title: '仪表盘',
    description: '站点搜索与下载状态',
    resourceStatus: '资源状态',
    sites: '站点',
    downloaders: '下载器',
    loadingStatus: '正在读取状态',
    readStatusFailed: '读取状态失败',
    resourceStatusReadFailed: '{resource}状态读取失败',
    notConfigured: '尚未配置{resource}',
    available: '{count} 个{resource}可用',
    configuredSummary: '{configured} 个已配置 · {enabled} 个已启用',
    notFetched: '暂未获取',
    connection: '连接',
    responseTime: '响应',
    ratio: '分享率',
    ...
    downloadSpeed: '下载速度',
    uploadSpeed: '上传速度',
    accumulatedDownload: '累计下载',
    accumulatedUpload: '累计上传',
    downloadDirectoryFreeSpace: '下载目录可用空间',
    pathMappings: '路径映射',
    pathMappingCount: '{count} 条',
    noPathMappings: '未配置路径映射',
    manageSites: '管理站点',
    configureDownloaders: '配置下载器',
    addSite: '添加站点',
    addDownloader: '添加下载器',
  ...
  liteDownloadTask: {
    category: '分类',
    downloadLimit: '下载限速 (KB/s)',
    uploadLimit: '上传限速 (KB/s)',
    savePath: '保存路径',
    resume: '恢复',
    missingResultHandle: '缺少种子结果句柄',
  },
  litePlugin: {
    loadErrorTitle: '组件加载错误',
    loadErrorText: '无法加载插件全页组件。',
    dashboardLoadFailed: '插件仪表盘加载失败',
  },
  liteSearch: {
    keyword: '关键词',
    sites: '站点',
    ...
    emptyTitle: '搜索站点种子',
    emptyText: '输入关键词后查看原始种子结果',
    settings: {
      basicDescription: '设置手动下载任务使用的下载器标签。',
      siteScopeDescription: '设置关键词搜索默认使用的站点范围。',
    },
  },
  dashboard: {
    storage: '存储空间',
  ...
  setting: {
    ...
    system: {
      custom: '自定义',
      basicSettings: '基础设置',
      basicSettingsDesc: '设置访问地址、接口令牌和外观',
      downloaderSettings: '下载器设置',
      downloaderSettingsDesc: '配置下载器连接、默认下载器和下载目录',
      addDownloader: '添加下载器',
      downloadDirectorySettings: '下载目录',
      downloadDirectorySettingsDesc: '配置手动下载可选择的本地目录，留空时使用优先级最高的目录',
      directoryName: '目录名称',
      downloadPath: '下载路径',
      addDownloadDirectory: '添加下载目录',
      removeDownloadDirectory: '删除下载目录',
      defaultDownloadDirectory: '下载目录',
      noDownloadDirectories: '尚未配置下载目录',
      directorySaveSuccess: '下载目录保存成功',
      directorySaveFailed: '下载目录保存失败！',
      appDomain: '访问域名',
