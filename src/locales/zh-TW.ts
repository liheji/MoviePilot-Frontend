export default {
  ...
  settingTabs: {
    system: {
      title: '系統',
      description: '存取網址、API 權杖、外觀與執行日誌',
    },
    downloader: {
      title: '下載器',
      description: 'qBittorrent、Transmission 等下載器的連線與下載目錄',
    },
    directory: {
      title: '存儲 & 目錄',
    ...
    search: {
      title: '搜索 & 下載',
      description: '關鍵詞站點搜索、下載任務標籤與搜索站點範圍',
    },
    subscribe: {
      title: '訂閱',
  ...
  liteDashboard: {
    title: '儀表盤',
    description: '站點搜尋與下載狀態',
    resourceStatus: '資源狀態',
    sites: '站點',
    downloaders: '下載器',
    loadingStatus: '正在讀取狀態',
    readStatusFailed: '讀取狀態失敗',
    resourceStatusReadFailed: '{resource}狀態讀取失敗',
    notConfigured: '尚未設定{resource}',
    available: '{count} 個{resource}可用',
    configuredSummary: '{configured} 個已設定 · {enabled} 個已啟用',
    notFetched: '暫未取得',
    connection: '連線',
    responseTime: '回應',
    ratio: '分享率',
    ...
    downloadSpeed: '下載速度',
    uploadSpeed: '上傳速度',
    accumulatedDownload: '累計下載',
    accumulatedUpload: '累計上傳',
    downloadDirectoryFreeSpace: '下載目錄可用空間',
    pathMappings: '路徑對應',
    pathMappingCount: '{count} 條',
    noPathMappings: '未設定路徑對應',
    manageSites: '管理站點',
    configureDownloaders: '設定下載器',
    addSite: '新增站點',
    addDownloader: '新增下載器',
    pluginExtensions: '插件擴充',
  },
  liteDownloadTask: {
    category: '分類',
    downloadLimit: '下載限速 (KB/s)',
    uploadLimit: '上傳限速 (KB/s)',
    savePath: '保存路徑',
    resume: '恢復',
    missingResultHandle: '缺少種子結果控制代碼',
  },
  litePlugin: {
    loadErrorTitle: '元件載入錯誤',
    loadErrorText: '無法載入插件全頁元件。',
    dashboardLoadFailed: '插件儀表板載入失敗',
  },
  liteSearch: {
    keyword: '關鍵詞',
    sites: '站點',
    ...
    download: '下載',
    keywordRequired: '請輸入搜尋關鍵詞',
    noResults: '找不到資源',
    searchFailed: '搜尋失敗',
    downloadAdded: '下載任務已新增',
    emptyTitle: '搜尋站點種子',
    emptyText: '輸入關鍵詞後查看原始種子結果',
    settings: {
      basicDescription: '設定手動下載任務使用的下載器標籤。',
      siteScopeDescription: '設定關鍵字搜尋預設使用的站點範圍。',
    },
  },
  dashboard: {
    storage: '存儲空間',
  ...
  setting: {
    ...
    system: {
      custom: '自定義',
      basicSettings: '基礎設置',
      basicSettingsDesc: '設置存取網址、API 權杖與外觀',
      downloaderSettings: '下載器設置',
      downloaderSettingsDesc: '設定下載器連線、預設下載器與下載目錄',
      addDownloader: '新增下載器',
      downloadDirectorySettings: '下載目錄',
      downloadDirectorySettingsDesc: '設定手動下載可選擇的本機目錄，留空時使用優先級最高的目錄',
      directoryName: '目錄名稱',
      downloadPath: '下載路徑',
      addDownloadDirectory: '新增下載目錄',
      removeDownloadDirectory: '刪除下載目錄',
      defaultDownloadDirectory: '下載目錄',
      noDownloadDirectories: '尚未設定下載目錄',
      directorySaveSuccess: '下載目錄儲存成功',
      directorySaveFailed: '下載目錄儲存失敗！',
      appDomain: '訪問域名',
