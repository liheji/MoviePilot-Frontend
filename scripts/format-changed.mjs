...
const DEFAULT_BASE_REFS = ['refs/remotes/upstream/lite', 'refs/remotes/origin/lite', 'refs/heads/lite']
...
function resolveDefaultBase(cwd, headCommit) {
  ...
  throw new Error('无法定位可比较的 Lite 基线，请通过 --base <ref> 显式指定比较起点。')
}
